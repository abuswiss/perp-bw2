...
import { Download, Copy, Save, FileText, CheckCircle } from 'lucide-react';
...
const DocumentActions = ({ 
  ...
  // Auto-save effect
  useEffect(() => {
    if (autoSave && content && !autoSaved && currentMatter) {
  ...
  }, [autoSave, content, autoSaved, currentMatter]);

  const performAutoSave = async () => {
    if (!currentMatter || autoSaved || saving) return;
